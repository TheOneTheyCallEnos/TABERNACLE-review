...
INFRASTRUCTURE_OUTPUT_DIR = DESKTOP / "INFRASTRUCTURE_PLAN"
...
The complete LVS theorem has been synthesized and written to the Desktop.
...
"""
        for f in state.infrastructure_files:
            report += f"- `{f}`\n"
        report += """
Check ~/Desktop/INFRASTRUCTURE_PLAN/ for implementation details.
